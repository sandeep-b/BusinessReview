angular.module("myApp").controller('businessDashboardController',
function($state,getBusinessesDashboardResolve,toastr,$localStorage,authenticationService,userDashboardServices,
    $stateParams,$uibModal,$scope
    ){

	var vm=this;
    vm.businesses=getBusinessesDashboardResolve;
